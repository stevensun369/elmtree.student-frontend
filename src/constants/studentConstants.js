...
// get average marks
export const STUDENT_GET_AVERAGE_REQUEST =
  'STUDENT_GET_AVERAGE_REQUEST'
export const STUDENT_GET_AVERAGE_SUCCESS =
  'STUDENT_GET_AVERAGE_SUCCESS'
export const STUDENT_GET_AVERAGE_FAIL = 'STUDENT_GET_AVERAGE_FAIL'

// get average marks
export const STUDENT_GET_TERM_MARKS_REQUEST =
  'STUDENT_GET_TERM_MARKS_REQUEST'
export const STUDENT_GET_TERM_MARKS_SUCCESS =
  'STUDENT_GET_TERM_MARKS_SUCCESS'
export const STUDENT_GET_TERM_MARKS_FAIL =
